...
int main() {
    constexpr long numIterations = 1'00'000'000;

    // Занимает больше времени, так как выполняется последовательно.
    // Approximate value of PI (sync): 3.14159, Time: 0.291114 seconds
    ...
    // Approximate value of PI (parallel wrong): 0.00016915, Time: 0.358566 seconds
    ...
    // Approximate value of PI (parallel atomic): 3.14159, Time: 11.096 seconds
    startTime = std::chrono::high_resolution_clock::now();
    ...
    // Approximate value of PI (parallel reduction): 3.14159, Time: 0.0567622 seconds
    startTime = std::chrono::high_resolution_clock::now();
